...
{
    [PanelActionDescriptor("Joy Stroke")]
    public class JoyStroke : Extension, IPanelAction
    {
        ...
        public object? Do()
        {
            ...
            bool Success = Joystick.SetBtn(true, vJoyID, ButtonNumber);
            Success &= Joystick.SetBtn(false, vJoyID, ButtonNumber);
            if (!Success)
